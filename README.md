...
| 3 种可访问阅读模式 | `build.py` 的 `ACCESSIBILITY_MODES` |
| 71 套历史色板来源档案 | `themes/themes.json` |
...
- 教程笔记 Part 1–3。
- 3 种可访问阅读模式；原有 71 套色板保留为可搜索来源档案。
...
- **可读性优先**：公开外观收敛为跟随系统、高可读浅色、高对比深色三种模式；历史色板只保留为来源档案，公共组件接入 Jason DS v2.1。
