...
# Tim Holman 的 GitHub Corner（github.com/tholman/github-corners，MIT 协议）
# 右上角斜带 octocat，hover 时手挥动
GITHUB_CORNER_HTML = """<a href="https://github.com/estelledc/hust-eic-os-review" class="github-corner" target="_blank" rel="noopener" aria-label="在 GitHub 查看源码">
  <svg width="80" height="80" viewBox="0 0 250 250" aria-hidden="true">
    <path d="M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z" fill="var(--accent, #2962ff)"></path>
